...
<main class="container py-4">
    ...
    <%
        ...
        // ==== Datos desde ListServlet (S3) ====
        java.util.List<String> s3 = (java.util.List<String>) request.getAttribute("s3Images");
    %>
    ...
    <div class="alert alert-warning">No hay imágenes locales aún. Sube algunas desde la pestaña <strong>Subir</strong>.</div>
    <% } else { %>
    <div class="row g-3">
    ...
    <hr>
    <h3 class="m-0 mt-4">
        Imágenes en S3 <small class="text-muted fs-6">(pre-signed URLs)</small>
    </h3>
    <div class="row g-3 mt-2">
        <% for (String url : s3) { %>
        <div class="col-6 col-md-3">
            <div class="card shadow-sm">
                <img class="thumb card-img-top" src="<%=url%>" alt="Imagen S3">
                <div class="card-body small text-truncate"><%=url%></div>
            </div>
        </div>
        <% } %>
    </div>
